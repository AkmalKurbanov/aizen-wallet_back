...
class Page extends ContentBase
{
    ...
    public function getTextImgTitleTypeOptions(){
    return array('1' => 'Серый градиент (слева направо )', 2 => 'Серый градиент ( справа налево )', 3 => 'Акцентировный цвет');
}
    public function getTitleTextTitleTypeOptions(){
    return array('1' => 'Серый градиент (слева направо )', 2 => 'Серый градиент ( справа налево )', 3 => 'Акцентировный цвет');
}
    public function getTextImgBlurTitleTypeOptions(){
    return array('1' => 'Серый градиент (слева направо )', 2 => 'Серый градиент ( справа налево )', 3 => 'Акцентировный цвет');
}
    public function getTitleSubtitleTitleTypeOptions(){
    return array('1' => 'Серый градиент (слева направо )', 2 => 'Серый градиент ( справа налево )', 3 => 'Акцентировный цвет');
}
    public function gethero2imgsTitleTypeOptions(){
    return array('1' => 'Серый градиент (слева направо )', 2 => 'Серый градиент ( справа налево )', 3 => 'Акцентировный цвет');
}
  
    public function getTrippleBlockBgIconOptions(){
